    ...
    select_servicio.on('change', function () {
        ...
        if (selectedProvincia && selectedOficina && selectedServicio) {
            ...
            var checkoutItem = $('<div class="checkout-item">' +
                ...
                '   <button class="delete-item"><img src="https://uploads-ssl.webflow.com/652f00909568ce58c099d55f/652f00919568ce58c099d689_Exit.svg" alt="Delete" style="width: 20px; height: 20px;"></button>' +
                '</div>' +
                '</div>');
